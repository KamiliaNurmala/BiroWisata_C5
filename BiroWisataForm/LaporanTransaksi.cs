...
namespace BiroWisataForm
{
    public partial class LaporanTransaksi : Form
    {
        ...
        private void SetupReportViewer()
        {
            ...
            // string connectionString = "Data Source=MSI;Initial Catalog=BiroWisata;Integrated Security=True;"; // Sesuaikan connection string Anda
            string connectionString = @"Data Source=KAMILIA\KAMILIANURMALA;Initial Catalog=BiroWisata;Integrated Security=True;";
            ...
            // Make sure "TransaksiDataSet" matches your RDLC dataset name (the name you gave in TransaksiDataSet.xsd)
            ...
            reportViewer1.LocalReport.ReportPath = @"D:\Semester 4\Pengembangan Aplikasi Basis Data\BiroWisataForm-Final2\BiroWisataForm-Final\BiroWisataForm\BiroWisataForm\Report1.rdlc"; // Sesuaikan path file .rdlc Anda
